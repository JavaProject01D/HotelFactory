...
public interface CustomerDAO {
	...
	/**
	 * Adds a customer to the database. The customer is added in Email order as
	 * to keep the database in sorted order. Only one customer can be inserted
	 ...
	 */
	void add(Customer cust) throws DuplicateCustomerException;
	 ...
	 *             If there is no customer with the specified email.
	 */
	Customer getCustomer(Email email) throws NonExistingCustomerException;
	 ...
	 */
	void update(Email email, CreditCard card) throws NonExistingCustomerException;
}
